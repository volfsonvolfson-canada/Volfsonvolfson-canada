<?php
// Server-Side Rendering for Kelder page
require_once 'common.php';

// Redirect from .html to .php if accessed via old URL
if (basename($_SERVER['PHP_SELF']) === 'room-second-suite.html' || 
    (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], 'room-second-suite.html') !== false)) {
    header('Location: room-second-suite.php', true, 301);
    exit;
}
  ...
  <section class="hero-contained" aria-label="Room banner">
    <div class="container">
      ...
      <?php else: ?>
        ...
        <img id="room-second-banner" 
             class="hero-contained-img basement-banner-cropped" 
             src="assets/forest-bear.jpg" 
             alt="Bear in forest"
             loading="eager"
             onerror="this.onerror=null; this.src='assets/forest-bear.jpeg'; this.onerror=function(){this.src='assets/forest-bear.JPG'; this.onerror=function(){this.src='assets/forest-bear.JPEG';};};" />
      <?php endif; ?>
    </div>
  </section>
  <style>
  ...
  <main class="section">
    <div class="container room-hero">
      <section>
        ...
        <div class="gallery" id="room-second-gallery">
        ...
        <div class="gallery" id="room-second-common-gallery">
...
<?php require __DIR__ . '/site_footer.php'; ?>
  ...
  <script>
    ...
    (function() {
      ...
      const banner = document.getElementById('room-second-banner');
      if (banner) {
        ...
        Object.defineProperty(banner, 'src', {
          ...
          set: function(value) {
            ...
            if (value && 
                ...
                !value.includes('forest-bear') &&
                value.startsWith('assets/') &&
                (value.includes('banner') || value.includes('room-second'))) {
              srcValue = value;
        ...
        if (typeof window !== 'undefined') {
          ...
          window.__preventResolveImages.push('room-second-banner');
        }
      }
    })();
  </script>
